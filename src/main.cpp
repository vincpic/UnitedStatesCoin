...
uint256 hashGenesisBlock("0xa6c4ab05e7561c0d658ce5da8d82073214f130f67e0f004659c2eae4e4df7bc4");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // UnitedStatesCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "UnitedStatesCoin Signed Message:\n";
...
{
    // UnitedStatesCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // UnitedStatesCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // UnitedStatesCoin: 3.5 days
static const int64 nTargetSpacing = 150; // UnitedStatesCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // UnitedStatesCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // UnitedStatesCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // UnitedStatesCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd06a4dd565bae61fe9ff961a4ee23aadf0c7fe20cc618c0f9bf3f127f5dd6657");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("53153f25bc9512b9599d29267d9c6fceaa117747eb00d4eaf3dde6b85a7c1497e679c7257538ac678ed276de199cdf55a80810c1e01263e341f131d1aaa06cef6d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1484583668;
        block.nBits    = 504365644;
        block.nNonce   = 838403698;

        if (fTestNet)
        {
            block.nTime    = 1484583668;
            block.nNonce   = 3364236531;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x41d39ce0a6998974993bad9f3d23769622f57b77edfc7c20f5b2db587eec7200"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // UnitedStatesCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    //// debug print
    printf("UnitedStatesCoin RPCMiner:\n");
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("UnitedStatesCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("UnitedStatesCoinMiner : ProcessBlock, block not accepted");
    }
